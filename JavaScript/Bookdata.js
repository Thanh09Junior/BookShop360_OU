...
function loadBookData(bookId) {
    ...
    //Lấy id của các tag có sẵn trong Book.html
    ...
    //Cập nhật phần nội dung tương ứng dữ liệu từ database
    ...
    descriptionList.innerHTML = ""; //Làm rỗng phần mô tả hiện tại
    book.description.forEach(function (item) {
        let li = document.createElement("li");
        li.innerText = item;
        descriptionList.appendChild(li);
    });

    // Truyển id sang giỏ hàng
